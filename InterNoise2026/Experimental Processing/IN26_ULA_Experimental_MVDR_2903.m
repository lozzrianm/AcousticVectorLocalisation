...
csv_filename_a1 = 'ULA_MEMS_Array1_Signal_fixed.csv';
convert_wav_a1 = true;
...
csv_filename_a2 = 'ULA_MEMS_Array2_Signal_fixed.csv';
convert_wav_a2 = true;
...
max_binwidth = 1 / (8 * d_y * (N_mics - 1) / c_0);
