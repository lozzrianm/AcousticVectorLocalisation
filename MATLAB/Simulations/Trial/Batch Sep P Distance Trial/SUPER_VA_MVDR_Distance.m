...
for array = 1:N_a
    ...
    [response_db_arrays{array}, mean_condition_number] = mvdr_vs_beamforming(r_vs_arrays{array}, ...
...
function [response_db, mean_condition_number] = mvdr_vs_beamforming(r_vs, vs_centres, candidate_points, ...
