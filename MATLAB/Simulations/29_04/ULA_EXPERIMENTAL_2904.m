...
wav_filename_a1 = '20260330-020226(UTC)-Trial13.convent.ULA.4MIC.0.4m.5.143cmdelta.pos1fixed.1khz-0166987641.wav';
csv_filename_a1 = 'MPA416_MEMS_Array1_Signal_fixed.csv';
convert_wav_a1 = true;

% Array 2 input file parameters
wav_filename_a2 = '20260330-013611(UTC)-Trial10.convent.ULA.4MIC.0.4m.4.5cmdelta.pos2fixed.1khz-0165412946.wav';
...
[~, ~, ~] = beam_pattern_ula(...
    ...
    bin_freqs, c_0, loading, radius, 'Combined 8-Mic ULA Beam Pattern (MVDR)');
